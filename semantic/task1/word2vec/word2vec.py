...
# @Last Modified time: 2019-03-24 22:08:24
...
class SG(object):
    ...
    def moudle_train(self):
        ...
        with tf.Session(graph=train_graph) as sess:
            ...
            pickle.dump(embed_mat, open(
                checkpoint_path + "embed_mat.pickle", 'wb'))
    ...
    def reload_model(self):
        self.embed_mat = pickle.load(
            open(checkpoint_path + "embed_mat.pickle", 'rb'))
